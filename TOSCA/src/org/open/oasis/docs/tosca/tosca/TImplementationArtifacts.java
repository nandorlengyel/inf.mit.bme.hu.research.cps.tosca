 ...
 * </p>
 * <ul>
 *   <li>{@link org.open.oasis.docs.tosca.tosca.TImplementationArtifacts#getImplementationArtifact <em>Implementation Artifact</em>}</li>
 * </ul>
 *
 * @see org.open.oasis.docs.tosca.tosca.TOSCAPackage#getTImplementationArtifacts()
...
public interface TImplementationArtifacts extends EObject {
	 ...
	 * The list contents are of type {@link org.open.oasis.docs.tosca.tosca.ImplementationArtifactType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.open.oasis.docs.tosca.tosca.TOSCAPackage#getTImplementationArtifacts_ImplementationArtifact()
